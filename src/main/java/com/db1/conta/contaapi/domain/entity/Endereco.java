...
public class Endereco<tipoEndereco, tipoEndereco1, cidade> {
	...
	public Endereco(Cliente cliente, String logradouro, String numero, Cidade cidade, tipoEndereco1 tipoEndereco, String complemento, String cep) {
	...
	public <TipoEndereco> tipoEndereco1 getTipoEndereco() {
		return tipoEndereco;
	}
